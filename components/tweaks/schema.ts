...
export const COLOR_TOKENS: ColorToken[] = [
  { id: "tape", label: "Background", cssVar: "--tape", default: "#14110f" },
  { id: "tape-2", label: "Panel", cssVar: "--tape-2", default: "#1b1714" },
  { id: "paper", label: "Ink — primary", cssVar: "--paper", default: "#f6f1e7" },
  { id: "steel", label: "Ink — secondary", cssVar: "--steel", default: "#b8bcc2" },
  { id: "rust", label: "Accent", cssVar: "--rust", default: "#b5502e" },
  { id: "rust-lit", label: "Accent — hover", cssVar: "--rust-lit", default: "#d06438" },
  { id: "rule", label: "Border", cssVar: "--rule", default: "#332d27" },
  {
    id: "phosphor",
    label: "Signal",
    cssVar: "--phosphor",
    default: "#39ff6a",
    hint: "Reserved for live indicators — the oscilloscope, LED dots, meter peaks.",
  },
];
...
export const RANGE_TOKENS: RangeToken[] = [
  { id: "type-scale", label: "Display type scale", cssVar: "--type-scale", min: 0.7, max: 1.6, step: 0.05, default: 1, unit: "×" },
  { id: "tracking-scale", label: "Label tracking", cssVar: "--tracking-scale", min: 0, max: 2.2, step: 0.1, default: 1, unit: "×" },
  { id: "gutter", label: "Container gutter", cssVar: "--pad", min: 12, max: 72, step: 2, default: 32, unit: "px" },
  { id: "band-gap", label: "Section rhythm", cssVar: "--band-gap", min: 24, max: 140, step: 4, default: 64, unit: "px" },
  { id: "maxw", label: "Content max-width", cssVar: "--maxw", min: 860, max: 1600, step: 20, default: 1240, unit: "px" },
  { id: "radius", label: "Panel radius", cssVar: "--radius", min: 0, max: 28, step: 1, default: 0, unit: "px" },
  { id: "border-w", label: "Panel border width", cssVar: "--border-w", min: 0, max: 4, step: 0.5, default: 1, unit: "px" },
  { id: "motion-speed", label: "Motion speed", cssVar: "--motion-speed", min: 0.25, max: 2.5, step: 0.05, default: 1, unit: "×" },
];

/** Not a CSS var — read directly by the canvas engine at draw time. */
export const SIGNAL_INTENSITY_DEFAULT = 1;
...
export const DISPLAY_FONTS: FontOption[] = [
  { id: "archivo-black", label: "Archivo Black (default)", cssValue: '"Archivo Black", "Arial Black", system-ui, sans-serif' },
  { id: "anton", label: "Anton", cssValue: '"Anton", "Arial Black", system-ui, sans-serif', googleFamily: "Anton" },
  { id: "bebas-neue", label: "Bebas Neue", cssValue: '"Bebas Neue", "Arial Black", system-ui, sans-serif', googleFamily: "Bebas+Neue" },
...
export const BODY_FONTS: FontOption[] = [
  ...
  { id: "newsreader", label: "Newsreader (serif)", cssValue: '"Newsreader", Georgia, serif', googleFamily: "Newsreader:wght@400;500;600" },
  { id: "literata", label: "Literata (serif)", cssValue: '"Literata", Georgia, serif', googleFamily: "Literata:wght@400;500;600" },
];

export const MACH_FONTS: FontOption[] = [
  { id: "special-elite", label: "Special Elite (default)", cssValue: '"Special Elite", "Courier New", monospace' },
  ...
  { id: "jetbrains-mono", label: "JetBrains Mono", cssValue: '"JetBrains Mono", "Courier New", monospace', googleFamily: "JetBrains+Mono:wght@400;500;600" },
...
export const PRESETS: Preset[] = [
  ...
  },
  {
    ...
    state: {
      colors: { rust: "#e8622f", "rust-lit": "#ff7a3d" },
  ...
  },
  {
    id: "cold-signal",
    label: "Cold Signal",
    description: "Rust swapped for a cool cyan accent, on a cooler near-black ground.",
    state: {
      colors: { tape: "#0d1013", "tape-2": "#141a1e", paper: "#edf2f4", steel: "#a9b7be", rust: "#3e7cb1", "rust-lit": "#5a9bce" },
  ...
  },
  {
    id: "editorial",
    label: "Editorial",
    description: "A typographic pivot only — serif body copy, condensed display, more air between sections.",
    state: {
      displayFont: "oswald",
      bodyFont: "newsreader",
